<template>
    <div class="demo-holder">
        ...
        <div class="common-box">
            <NvMDBillboard :dataUrl="dataUrl" :params="params" :conf="billboardConf" />
        </div>
        <h1>demo</h1>
        <p>组件调用</p>
        <div class="code">
            <pre>&lt;NvMDBillboard :path=&quot;billboardPath&quot; :url=&quot;url&quot; :dataUrl=&quot;dataUrl&quot; :params=&quot;params&quot; /&gt;</pre>
        </div>
        <p>数据配置:配置path获取数据</p>
        <div class="code">
            <pre>
        ...
        <div class="common-box">
            <NvMDBillboard :path="billboardPath" :url="confUrl" :dataUrl="dataUrl" :params="params"/>
        </div>
        ...
        <div class="common-box">
            <NvMDBillboard :conf="billboardConf" :dataUrl="dataUrl" :params="params"/>
        </div>
        <p>无配置调用</p>
        <div class="code">
        ...
        <div class="common-box">
            <NvMDBillboard :conf="billboardDisplay" :params="params"/>
        </div>
        <p>多数据源配置方式</p>
        <div class="code">
        ...
        <div class="common-box">
            <NvMDBillboard :conf="billboardDataSource" :params="params"/>
        </div>
        <h1>API</h1>
        <Table
            :columns="columns"
