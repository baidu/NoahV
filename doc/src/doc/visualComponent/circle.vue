<template>
   <div class="demo-holder">
        <h1>概述</h1>
        <p>可视化组件中的仪表图组件，可以根据指标数据决定显示颜色。适合于可用性、容量等数值展示。一个仪表图只能展示一个数据。该数据可以是一个指标、也可以是同一个namespace下多个指标运算后结果。</p>
        <h1>组件实例</h1>
        ...
        <div class="common-box">
            <NvMDCircle :conf="circleConf" :dataUrl="dataUrl" :params="params"/>
        </div>
        <h1>demo</h1>
        <p>组件调用</p>
        <div class="code">
            <pre>&lt;NvMDCircle :path=&quot;circlePath&quot; :url=&quot;url&quot; :dataUrl=&quot;dataUrl&quot; :params=&quot;params&quot;/&gt;</pre>
        </div>
        <p>数据配置:配置path获取数据</p>
        <div class="code">
            <pre>
        ...
        <div class="common-box">
            <NvMDCircle :path="circlePath" :url="confUrl" :dataUrl="dataUrl" :params="params"/>
        </div>
        ...
        <div class="common-box">
            <NvMDCircle :conf="circleDisplay" :params="params"/>
        </div>
        <p>多数据源配置方式</p>
        <div class="code">
        ...
        <div class="common-box">
            <NvMDCircle :conf="circleDataSource" :params="params"/>
        </div>
        <h1>API</h1>
        <Table
            :columns="columns"
