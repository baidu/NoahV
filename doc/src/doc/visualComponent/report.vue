<template>
   <div class="demo-holder">
        ...
        <p>组件调用</p>
        <div class="code">
            <pre>&lt;NvMDReport :path=&quot;reportPath&quot; :url=&quot;confUrl&quot; :dataUrl=&quot;dataUrl&quot; :params=&quot;params&quot;/&gt;</pre>
        </div>
        <p>数据配置:配置path获取数据</p>
        <div class="code">
            <pre>
        ...
        <p>数据展开情况</p>
        <div class="code">
            <pre>&lt;NvMDReport :path=&quot;reportPath&quot; :url=&quot;confUrl&quot; :dataUrl=&quot;dataTreeUrl&quot;/&gt;</pre>
        </div>
        <div class="code">
            <pre>
            export default {
        ...
        <div class="common-box">
            <NvMDReport :path="reportPath" :url="confUrl" :dataUrl="dataTreeUrl" :params="params"/>
        </div>
        <p>多数据源配置方式</p>
        <div class="code">
        ...
        <div class="common-box">
            <NvMDReport :conf="reportDataSource" :params="params"/>
        </div>
        <h1>API</h1>
        <Table
            :columns="columns"
            ...
            reportConf: {
                ...
                'data': {
                    ...
                    'columns': [
                        ...
                        {
                            'source': 'origin', // 使用列数据，选择该模式时，use必须为true，没有时间选择和offset，没有alias
                            'group': 'group',
                            'header': '列名2',
                            'alias': 'alias2',
                            'metric': '#{metric1}-#{metric2}',
