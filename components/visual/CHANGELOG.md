## ChangeLog
## 1.0.57
* [功能优化] 趋势图增加默认defaultSort属性
## 1.0.56
* [功能优化] 趋势图排序icon修改
## 1.0.55
* [功能优化] 新增趋势图排序默认asc
## 1.0.54
* [功能修复] 修复趋势图title为空时报错
## 1.0.53
* [功能新增] 增加趋势图ToolTips排序功能
## 1.0.52
* [功能优化] 优化表格排序样式
## 1.0.51
* [功能优化] 增加表格排序显示隐藏api
...
* [功能修复] 向下趋势图兼容单位配置
## 1.0.49
* [功能修复] 修复趋势图y轴坐标数值一样问题
## 1.0.48
* [功能优化] 仪表盘趋势图中国际化问题："切换为平铺"未翻译——功能回退
## 1.0.47
* [功能修复] fix：修复趋势图tofixed报错
## 1.0.46
* [功能优化] 仪表盘趋势图中国际化问题："切换为平铺"未翻译
## 1.0.45
* [功能优化] 增加面板文字省略tips，趋势图y轴坐标统一小数位
## 1.0.44
* [功能优化] 修复仪表图最小值变化显示比例不对问题
## 1.0.43
* [功能优化] 修复趋势图/billboar
## 1.0.42
* [功能优化] 无数据时饼图展示问题
