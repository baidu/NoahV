## ChangeLog
## 1.1.69
* [功能修复] 修复textarea高亮功能正则匹配bug
## 1.1.68
* [功能优化] 修复chart浏览器模式获取body节点的bug
## 1.1.67
* [功能优化] 允许用户传入趋势图的点
## 1.1.66
...
## 1.1.61
* [功能优化] tab栏新增数量max及禁止重复name输入
## 1.1.60
* [功能新增] 新增可编辑滚动tab栏
## 1.1.59
* [功能新增] 新增textArea文本框筛选高亮组件
## 1.1.58
* [功能新增] 趋势图增加维度信息展示
## 1.1.57
* [功能新增] multiselect组件加入allByResultList参数
## 1.1.56
* [功能新增] 趋势图增加自定义error内容的slot
## 1.1.55
* [功能新增] 树组件，搜索icon样式修改
## 1.1.54
* [功能新增] 树组件，搜索条件为空时取消高亮
## 1.1.53
* [功能新增] 日历组件，修复初始化时的时间问题
## 1.1.52
* [功能新增] 多选组件，增加disable状态

## 1.1.51
* [功能修复] 多选组件，搜索时不匹配显示空

## 1.1.50
* [功能修复] 树组件，解决点击应用，应用高亮显示，再次点击相同应用后高亮消失问题

## 1.1.49
* [功能新增] 多选组件，新增可搜索，可单选，可多选下拉多选组件

## 1.1.48
* [功能新增] 树组件，新增暴露节点鼠标点击事件
...
## 1.1.41
* [功能优化] 趋势图组件tooltip样式调整，默认为透明，趋势图数字按照万，亿单位调整

## 1.1.40
* [功能优化] 趋势图组件当展示统计详情信息时，依然拥有图例与时间滑块功能区

## 1.1.39
* [功能新增] 时间组件，新增禁止时间展示面板编辑配置
...
## 1.1.36
* [功能新增] 趋势图组件新增查看详情和坐标轴转换功能

## 1.1.35
* [功能新增] 时间组件params props增加验证类型Array

## 1.1.34
* [功能修复] 修复时间组件在不同时区的错误展示问题

## 1.1.33
* [功能修复] 修复值班表在不同时区的错误展示问题

## 1.1.32
* [功能修复] 修复趋势图Refresh方法在某些情况下失效的问题

## 1.1.31
* [功能新增] 级联多选组件，新增value字段
* [功能新增] 表单模板，新增级联多选组件的支持

## 1.1.30
* [功能修复] 时间组件，日历组件等，适配国际化
