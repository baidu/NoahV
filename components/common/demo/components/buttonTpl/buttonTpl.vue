<template>
    <div>
        ...
        <div class="usage-item">
            ...
            <div class="code">
                <pre><code><span>&lt;<span>nv-button-tpl :type="type" :content="content" :size="size" :icon="icon" :disabled="disabled" :action="action"</span>&gt;&lt;/nv-button-tpl&gt;</span></code></pre>
            </div>
            <h2>点击弹出自定义dialog后发送ajax请求按钮</h2>
            <div class="code">
                <pre><code><span>&lt;<span>nv-button-tpl :type="type" :content="content" :size="size" :icon="icon" :disabled="disabled" @click.native="click"</span>&gt;&lt;/nv-button-tpl&gt;</span></code></pre>
                <pre><code><span>&lt;<span>nv-dialog  type="dialog" :dialog="dialog"</span>&gt;&lt;/nv-dialog&gt;</span></code></pre>
            </div>
        </div>
        ...
        <div class="usage-item">
            ...
            <h4>效果</h4>
            <nv-button-tpl :content="content" :type="type" :size="size" :icon="icon" :disabled="disabled" :action="action">
            </nv-button-tpl>
